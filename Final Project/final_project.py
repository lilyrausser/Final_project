...
red_dull = (186, 0, 0)
red_bright  = (254, 0, 0)
yellow_dull = (225, 223, 0)
yellow_bright = (225,  225, 1)
green_dull  = (17, 119, 45)
green_bright = (48,  173, 35)
blue_dull = (2, 6,  159)
blue_bright = (8, 0, 255)
...
class Backdrop(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("Assets/backgrounds/game_background.jpg")
...
class Character(pygame.sprite.Sprite):
    ...
    def __init__(self, input_dict):
        ...
        self.images["right"] = pygame.image.load(
            "Assets/sprites/quit_button.png"
        )
